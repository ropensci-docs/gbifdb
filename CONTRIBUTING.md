# Contributing to gbifdb

This outlines how to propose a change to gbifdb. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("cboettig/gbifdb", fork = TRUE)`.
...
Please note that the gbifdb project is released with a [Contributor Code
of Conduct](https://docs.ropensci.org/gbifdb/CODE_OF_CONDUCT.md). By
